...
class FolderDataElement(DataElement):
    ...
    def __init__(self, simulationCode, unitConverter, nameInCode, standardName, location, timeSteps, speciesName = "", internalName = "", hasNonISUnits = True):
        DataElement.__init__(self, unitConverter, standardName, timeSteps, speciesName, hasNonISUnits)
...
class FolderField(FolderDataElement):
    def __init__(self, simulationCode, unitConverter, nameInCode, standardName, location, timeSteps, speciesName="", hasNonISUnits = True):
        FolderDataElement.__init__(self, simulationCode, unitConverter, nameInCode, standardName, location, timeSteps, speciesName, hasNonISUnits = hasNonISUnits)
...
class FolderRawDataSet(FolderDataElement):
    def __init__(self, simulationCode, unitConverter, nameInCode, standardName, location, timeSteps, speciesName, internalName, hasNonISUnits = True):
        FolderDataElement.__init__(self, simulationCode, unitConverter, nameInCode, standardName, location, timeSteps, speciesName, internalName, hasNonISUnits)
